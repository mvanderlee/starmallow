...
@app.get("/path/date_field")
def get_path_date_field() -> mf.Date:
    return dt.date(2023, 2, 27)


@app.get("/path/date_model", response_model=mf.Date())
def get_path_date_model():
    return dt.date(2023, 2, 27)


@app.get("/path/dataclass")
